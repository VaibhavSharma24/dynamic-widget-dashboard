...
interface ImageSecurityWidgetProps {
  data: ImageSecurityData
}

export default function ImageSecurityWidget({ data }: ImageSecurityWidgetProps) {
  ...
  return (
    <div className="p-4 h-full">
      <h3 className="font-medium mb-2">Image Security Issues</h3>
